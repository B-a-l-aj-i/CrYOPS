...
export function VercelTokenInput({
  ...
  const effectiveToken = _hasHydrated ? storedToken : undefined;
      ...
      <CardContent className="pt-1 text-left">
        ...
        {showInstructions && (
          <Card className="mb-4 border-blue-200 bg-blue-50 text-left">
            <CardHeader className="text-left">
              <CardTitle className="flex items-center gap-2 text-left text-blue-800">
                <AlertCircle className="h-5 w-5 shrink-0 text-blue-600" />
                How to get your Vercel Personal Access Token
              </CardTitle>
            </CardHeader>
            <CardContent className="text-left">
              <ol className="list-inside list-decimal space-y-1 text-left text-sm text-blue-700">
                <li>
                  Visit{" "}
                  <a
                ...
                <li>
                  Give your token a name scope and expiration(no expiration is
                  recommended)
                </li>
          ...
          <Card className="mb-4 border-green-200 bg-green-50 text-left">
            <CardContent className="pt-6 text-left">
              ...
              {storedToken && tokenCreated && (
                <div className="text-muted-foreground mt-2 text-left text-xs">
        ...
        <CardDescription className="mt-4 space-y-1 text-left">
          <p className="text-left text-xs">
            Learn more about{" "}
            <a
              href="https://vercel.com/docs/sign-in-with-vercel/tokens#access-token"
              target="_blank"
              rel="noopener noreferrer"
              className="underline hover:no-underline"
            >
